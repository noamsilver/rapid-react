...
var _apiCalls = __webpack_require__(79);

var api = _interopRequireWildcard(_apiCalls);
...
function login(username, password) {
  ...
  if (!token) {
    // Auto create account if not found (for simplicity)
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/', render: function render() {
              return !_this2.isLoggedIn() && _react2.default.createElement(_reactRouterDom.Redirect, { to: '/login' });
            } }),
          _react2.default.createElement(
...
var Login = function (_Component) {
  ...
  _createClass(Login, [{
    ...
    value: function handleChange(event) {
      ...
      this.setState((_setState = {}, _defineProperty(_setState, event.target.name, event.target.value), _defineProperty(_setState, 'message', ""), _setState));
    }
  }, {
    key: 'clickLogin',
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { type: 'text', name: 'username', id: 'username', placeholder: 'Username', value: this.state.username, onChange: this.handleChange }),
        _react2.default.createElement('input', { type: 'password', name: 'password', id: 'password', placeholder: 'Password', value: this.state.password, onChange: this.handleChange }),
        _react2.default.createElement(
          'div',
          { className: 'login button', onClick: this.clickLogin },
          'Login'
        ),
        _react2.default.createElement(
          'div',
...
function createSessionToken(username, password) {
  var usernames = JSON.parse(storage.getItem('usernames'));
  ...
  while (tokens && tokens[sessionToken.token]) {
    // Using this blocking 'while' loop as it will probably never actually be looped. This is because the random generator has a uniform distribution.
    sessionToken.token = getRandomInt(100000000000000, 999999999999999);
  }
...
function getToken(username, password) {
  ...
  var tokens = JSON.parse(storage.getItem('tokens'));
  var token = tokens[usernames[username]];
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'welcome' },
          'Welcome to Drag&Drop Forever'
        ),
        _react2.default.createElement(
          _reactRouterDom.Link,
          { to: '/login', className: 'logout', onClick: this.clickLogout },
          'Logout'
        ),
        _react2.default.createElement('div', { className: 'drag image' })
      );
    }
  }]);
